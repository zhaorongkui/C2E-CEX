export default {
    ...
    indexTxt5: 'Offizieller XCEX-Hilfskanal für Anfänger',
    ...
    account2: 'Erstellen Sie ein XCEX-Konto',
    ...
    labTxt: 'XCEX-Labor • Teilen Sie Innovationsergebnisse',
    labTxt2:
    ...
    attentiontxt4:
        '* Das endgültige Interpretationsrecht dieser Veranstaltung liegt beim offiziellen XCEX (WWW.XCEX.NET).',
    ...
    etmenu2: 'Ankündigung des XCEX-Server-Updates',
    ...
    reTxt: 'Xcex Financial Management • Anlagelösung aus einer Hand',
    ...
    prtit: 'Regeldetails',
    prdesc:
        'Der [Promotion-Partner] von XCEX ist eine Promotion-Aktivität mit der höchsten Provisions-Rabattquote und der längsten Rabattdauer (maximaler Lifetime-Rabatt) im gesamten Netzwerk, die es Promotern, die entsprechende Anstrengungen unternehmen, ermöglicht, ein echter „Partner“ der Plattform zu werden und die zu genießen Dividenden des gemeinsamen Wachstums mit der XCEX-Handelsplattform! ',
    prli1:
        '1. Um das Konzept digitaler Assets zu fördern und den Nutzerumfang zu erweitern, hat XCEX das [Promotion Partner]-Programm ins Leben gerufen, das seit langem wirksam ist.',
    prli2:
    ...
    prli8:
        '8. Die Top 10 oder Top 100 in der Rangliste der Werbeprovisionen erhalten von Zeit zu Zeit zusätzliche Belohnungen, die offiziell von XCEX vergeben werden.',
    prli9:
    ...
    prli11:
        '11. Das endgültige Interpretationsrecht dieser Aktivität liegt bei XCEX.',
    prth1: 'Ebene',
    ...
    pt_card_rule6:
        '6. Das endgültige Auslegungsrecht der kostenlosen Geschenkkarte liegt bei XCEX.',
    pt_card_day: 'Himmel',
    pt_card_title_tips:
    ...
    just_for_learning: 'Dieses Projekt dient nur zu Lern- und Kommunikationszwecken, nicht für kommerzielle Zwecke.'
};
