export default {
  ...
  indexTxt2: 'Specializing in cryptocurrency derivatives trading',
	...
	indexTxt5: 'Xcex Official Customer Service',
	...
	indexh8: 'Our mission',
	indexp1: 'WWW.XCEX. BIZ was founded by a group of early Bitcoin participants and geeks. The core members of the team are from well-known enterprises such as Google, Microsoft, Alibaba, Tencent, etc., with deep R&D strength and rich Internet product operation experience.',
	indexp2: 'WWW.XCEX. Located in the blockchain basic service provider, BIZ is committed to providing global users with a high-quality encrypted asset trading platform, adhering to the basic principle of "not doing evil", adhering to honest, fair and enthusiastic service to customers, and welcoming all partners/projects conducive to the fundamental interests of users with an open attitude.',
	...
	account2: 'Create a XCEX account',
	...
	attentiontxt4: "* The right of final interpretation of this activity belongs to the official ownership of Xcex.",
	// 币本位合约账户
	transfer: 'Transfer',
	...
	etmenu2: 'XCEX Server Update Announcement',
	// 当前委托-3
	et2menu1: 'RX.波场简介',
	et2menu2: '比特币是庞氏骗局吗?',
	// 历史委托
	...
	// 定期理财
	reTxt: 'Xcex Earn • One-stop investment solution',
	...
	prtit: 'Rule details',
	prdesc: '[Promotion Partner] is the highest proportion of online Commission return and the longest time of commission return (maximum lifetime commission). Promoters who make corresponding efforts can become real platform ‘partners’ and enjoy the dividend of growing together with Xcex trading platform. Detailed rules are as follows:',
	prli1: '1、In order to preach the concept of digital assets and expand the scale of users, Xcex launched the “Promotion Partner” program, which is effective for a long time.',
	...
	prli8: "8、TOP10 or TOP100 will be awarded additional incentives by Xcex from time to time.",
	...
	prli11: "11、The right of final interpretation of this activity belongs to Xcex.",
	prth1: 'Level',
	...
	abdesc14: 'Biyong',
	abdesc15: 'Telegram',
	abdesc16: "Add 'Xcex' as Wechat friends and then enter Wechat community",
	// 实名认证
	realtxt: 'Actual name',
	realtxt2: 'ID Card',
	...
	pt_card_rule6: "6. The right of final interpretation of free gift cards belongs to XcexEX.COM.",
	pt_card_day: "Days",
	...
	just_for_learning:"This project is for learning and communication purposes only, not for any commercial use."
}
