export default {
  ...
  indexTxt5: 'Canal auxiliar oficial de entrada de novatos de XCEX',
  ...
  account: 'Iniciar sesión en la cuenta XCEX',
  ...
  account2: 'Crear una cuenta XCEX',
  ...
  labTxt: 'Laboratorio XCEX • Compartir resultados de innovación',
  labTxt2:
  ...
  attentiontxt4:
    '*El derecho de interpretación final de esta actividad pertenece al XCEX oficial (WWW.XCEX.NET)',
  ...
  etmenu2: 'Anuncio de actualización del servidor XCEX',
  ...
  reTxt: 'Xcex Financial Management • Solución de inversión integral',
  ...
  prdesc:
    'El [Socio de promoción] de XCEX es una actividad de promoción con el índice de reembolso de comisión más alto y la duración de reembolso más larga (reembolso máximo de por vida) en toda la red, lo que permite a los promotores que realizan los esfuerzos correspondientes convertirse en un verdadero "socio" de la plataforma y disfrutar de ¡Dividendos de crecer junto con la plataforma comercial XCEX! ',
  prli1:
    '1. Para promover el concepto de activos digitales y ampliar la escala de usuarios, XCEX lanzó el programa [Promotion Partner], que es efectivo desde hace mucho tiempo.',
  prli2:
  ...
  prli8:
    '8. Los 10 primeros o 100 primeros en la lista de clasificación de la comisión de promoción recibirán recompensas adicionales emitidas oficialmente por XCEX de vez en cuando.',
  prli9:
  ...
  prli11:
    '11. El derecho de interpretación final de esta actividad pertenece a XCEX.',
  prth1: 'nivel',
  ...
  abtit3: 'Contáctenos',
  abtit4: 'Comunidad Xcex',
  abdesc:
    'XCEX es la plataforma de comercio de activos digitales con tecnología líder en el mundo. Está registrada en las Islas Caimán y su equipo operativo principal está ubicado en Hong Kong. ',
  abdesc2:
    'La plataforma XCEX tiene una estructura de transacciones de nivel financiero profesional y un motor de transacciones de coincidencia de memoria de alta concurrencia de desarrollo propio. La plataforma adopta un sistema de billetera de recarga completamente en frío + firma múltiple + sistema de ataque DDOS de alta protección y otras estructuras de transacciones para garantizar la seguridad de los activos de los clientes.',
  abdesc3:
    'Para permitir a los clientes aprovechar mejor las oportunidades de inversión, XCEX adopta una gestión plana dentro del departamento de servicio al cliente y establece un mecanismo de respuesta de servicio extremadamente rápido. El administrador de servicio al cliente de activos está en línea las 7 horas del día, las 24 horas del día, durante todo el año para brindar a los clientes servicios como recarga y retiro, asegurando que los clientes puedan responder en 5 minutos Complete el depósito y retiro de activos.',
  abdesc4:
    'XCEX selecciona estrictamente proyectos de alta calidad y brinda servicios de custodia de activos seguros y estables. ',
  abdesc5:
  ...
  pt_card_rule6:
    '6. El derecho de interpretación final de la tarjeta regalo gratuita pertenece a XCEX.',
  pt_card_day: 'cielo',
  ...
  just_for_learning: 'Este proyecto es solo para fines de aprendizaje y comunicación, no para ningún uso comercial.'
};
