export default {
  ...
  indexTxt5: "Canal auxiliaire officiel d'entrée des novices XCEX",
  ...
  indexp1:
    "XCEX a été fondée par un groupe de premiers participants et connaisseurs de Bitcoin. Les principaux membres de l'équipe viennent d'entreprises bien connues telles que Google, Microsoft, Alibaba et Tencent. Ils possèdent de profondes capacités de R&D et une riche expérience dans l'exploitation de produits Internet.",
  indexp2:
    "XCEX se positionne comme un fournisseur de services de blockchain de base et s'engage à fournir des plateformes de trading d'actifs cryptographiques de haute qualité aux utilisateurs mondiaux. Il adhère au principe de base de « ne pas faire le mal », insiste pour servir les clients de manière honnête, équitable et avec enthousiasme. et accueille toutes les parties intéressées avec une attitude ouverte. Partenaires/projets qui profitent aux intérêts fondamentaux des utilisateurs.",
  indexp3:
  ...
  account: 'Connexion au compte XCEX',
  ...
  labTxt: "Laboratoire XCEX • Partager les résultats de l'innovation",
  labTxt2:
  ...
  attentiontxt4:
    "* Le droit d'interprétation finale de cette activité appartient au XCEX officiel (WWW.XCEX.NET)",
  ...
  etmenu2: 'Annonce de mise à jour du serveur XCEX',
  ...
  reTxt: "Xcex Financial Management • Solution d'investissement unique",
  ...
  prdesc:
    "[Partenaire de promotion] de XCEX est une activité de promotion avec le taux de remise de commission le plus élevé et la durée de remise la plus longue (rabais maximum à vie) sur l'ensemble du réseau, permettant aux promoteurs qui déploient les efforts correspondants de devenir un véritable « partenaire » de la plateforme et de profiter du les dividendes de la croissance avec la plateforme de trading XCEX ! ",
  prli1:
    "1. Afin de promouvoir le concept d'actifs numériques et d'élargir l'échelle des utilisateurs, XCEX a lancé le programme [Promotion Partner], efficace depuis longtemps.",
  prli2:
  ...
  prli8:
    '8. Les 10 ou 100 premiers du classement des commissions de promotion recevront de temps à autre des récompenses supplémentaires officiellement émises par XCEX.',
  prli9:
  ...
  prli11:
    "11. Le droit d'interprétation finale de cette activité appartient à XCEX.",
  prth1: 'niveau',
  ...
  abtit4: 'Communauté XCEX',
  abdesc:
    "XCEX est la première plateforme technologique de négociation d'actifs numériques au monde. Elle est enregistrée aux îles Caïmans et son équipe opérationnelle principale est située à Hong Kong. ",
  abdesc2:
    "La plate-forme XCEX dispose d'une structure de transaction professionnelle au niveau financier et d'un moteur de transaction de correspondance de mémoire à haute concurrence auto-développé.La plate-forme adopte un système de portefeuille de recharge entièrement à froid + multi-signature + système d'attaque DDOS à haute protection et d'autres structures de transaction pour assurer la sécurité des actifs des clients.",
  abdesc3:
    "Afin de permettre aux clients de mieux saisir les opportunités d'investissement, XCEX adopte une gestion plate au sein du service client et met en place un mécanisme de réponse de service extrêmement rapide. Le responsable du service client actifs est en ligne 7*24H toute l'année pour fournir aux clients des services tels que des actifs. recharge et retrait, garantissant que les clients peuvent recevoir des services dans les 5 minutes.Dépôt et retrait complets des actifs.",
  abdesc4:
    "XCEX sélectionne strictement des projets de haute qualité et fournit des services de conservation d'actifs sûrs et stables. ",
  abdesc5:
  ...
  pt_card_rule6:
    "6. Le droit d'interprétation finale de la carte cadeau gratuite appartient à XCEX.",
  pt_card_day: 'ciel',
  ...
  just_for_learning: 'Ce projet est uniquement destiné à l\'apprentissage et à la communication, pas à des fins commerciales.'
};
