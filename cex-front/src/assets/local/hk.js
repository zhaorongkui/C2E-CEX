export default {
    ...
    indexh7: '全球服務',
    indexh8: '嚴選項目',
    indexp1: 'XCEX 由一群比特幣早期參與者與極客創立，團隊核心成員來自於Google、微軟、阿里巴巴、騰訊等知名企業，具有深厚的研發實力與豐富的網路產品營運經驗。',
    indexp2: 'XCEX 定位於區塊鏈基礎服務商，致力於為全球用戶提供優質加密資產交易平台，秉承著「不作惡」的基本原則，堅持誠實、公正、熱情的服務於客戶，以開放的態度迎接一切有',
    ...
    attentiontxt4: '* 本活動最終解釋權歸Xcex(WWW.XCEX.NET)官方所有',
    transfer: '資金劃轉',
    placeholder: '搜尋幣種',
    bith1: '合約交易',
    bith2: '帳戶權益',
    ...
    prtxt6: '合夥級別',
    prtit: '規則詳情',
    prdesc: 'Xcex的【推廣合夥人】是全網返傭比例最高、返傭時長最長(最高終身返傭)的推廣活動，讓付出相應努力的推廣者能夠成為真正意義上的平台“合夥人”，享受',
    prli1: '一、為佈道數位資產理念與擴大用戶規模，Xcex推出【推廣合夥人】計劃，該活動長期有效。',
    ...
    abtit3: '聯絡我們',
    abtit4: 'Xcex社區',
    abdesc: 'Xcex是科技全球領先的數位資產交易平台，註冊於開曼群島，核心營運團隊位於香港。 ',
    abdesc2: 'Xcex平台擁有專業金融等級的交易架構，擁有自主研發的高並發記憶體撮合交易引擎，平台採用全冷充值皮夾系統+多重簽章+高防護DDOS攻擊系統等交易架構，確保客戶資產安全。',
    abdesc3: 'Xcex為了讓客戶更好的把握投資機會，客服部門內部採用扁平化管理，建立了極速服務響應機制，資產客服經理常年7*24H在線，為客戶提供資產充值提現等服務，保障客戶在5分鐘內',
    abdesc4: 'Xcex嚴格篩選優質專案並提供安全穩定的資產託管服務。 ',
    ...
    pt_card_rule6: '六、免費禮品卡最終解釋權歸Xcex所有。',
    pt_card_day: '天',
    ...
    just_for_learning: '本項目僅供學習和交流使用，不用於任何商業目的。'
};
