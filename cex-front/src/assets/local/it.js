export default {
  ...
  indexTxt5:
    "Canale ausiliario ufficiale per l'ingresso dei principianti XCEX",
  ...
  indexp1:
    'XCEX è stata fondata da un gruppo di primi partecipanti e fanatici di Bitcoin. I membri principali del team provengono da aziende famose come Google, Microsoft, Alibaba e Tencent. Hanno profonde capacità di ricerca e sviluppo e una ricca esperienza nella gestione di prodotti Internet.',
  indexp2:
    'XCEX si posiziona come fornitore di servizi blockchain di base e si impegna a fornire piattaforme di trading di criptovalute di alta qualità per utenti globali. Aderisce al principio di base di "non fare il male", insiste nel servire i clienti in modo onesto, equo ed entusiasta, e accoglie con un atteggiamento aperto tutte le parti interessate, partner/progetti che vanno a beneficio degli interessi fondamentali degli utenti.',
  indexp3:
  ...
  account: "Accesso all'account XCEX",
  ...
  labTxt: "Laboratorio XCEX • Condividere i risultati dell'innovazione",
  labTxt2:
  ...
  attentiontxt4:
    '* Il diritto di interpretazione finale di questo evento appartiene al sito ufficiale XCEX (WWW.XCEX.NET)',
  ...
  etmenu2: 'Annuncio di aggiornamento del server XCEX',
  ...
  reTxt: 'Xcex Financial Management • Soluzione di investimento unica',
  ...
  prdesc: `Il [Partner di promozione] di XCEX è un'attività di promozione con il rapporto di sconto sulle commissioni più alto e la durata di sconto più lunga (sconto massimo a vita) sull'intera rete, consentendo ai promotori che si impegnano in modo corrispondente di diventare un vero "partner" della piattaforma e godersi il dividendi della crescita insieme alla piattaforma di trading XCEX! `,
  prli1:
    '1. Al fine di promuovere il concetto di risorse digitali ed espandere la portata degli utenti, XCEX ha lanciato il programma [Promotion Partner], che è efficace da molto tempo.',
  prli2:
  ...
  prli8:
    '8. I primi 10 o i primi 100 nella classifica della commissione di promozione riceveranno di volta in volta ulteriori premi ufficialmente emessi da XCEX.',
  prli9:
  ...
  prli11:
    '11. Il diritto di interpretazione finale di questa attività appartiene a XCEX.',
  prth1: 'livello',
  ...
  abtit2: 'chi siamo',
  abtit3: 'Contattaci',
  abtit4: 'Comunità XCEX',
  abdesc:
    'XCEX è la piattaforma leader a livello mondiale per il trading di asset digitali con tecnologia. È registrata nelle Isole Cayman e il suo team operativo principale ha sede a Hong Kong. ',
  abdesc2:
    'La piattaforma XCEX ha una struttura di transazione professionale a livello finanziario e un motore di transazione di corrispondenza della memoria ad alta concorrenza sviluppato internamente. La piattaforma adotta un sistema di portafoglio con ricarica completamente a freddo + multi-firma + sistema di attacco DDOS ad alta protezione e altre strutture di transazione per garantire la sicurezza del patrimonio dei clienti.',
  abdesc3:
    "Per consentire ai clienti di cogliere al meglio le opportunità di investimento, XCEX adotta una gestione flat all'interno del servizio clienti e stabilisce un meccanismo di risposta del servizio estremamente rapido.Il responsabile del servizio clienti asset è online 7 ore su 7, 24 ore su 24, tutto l'anno per fornire ai clienti servizi come quelli asset ricarica e prelievo, garantendo che i clienti possano rispondere entro 5 minuti.Completare il deposito e il prelievo del bene.",
  abdesc4:
    'XCEX seleziona rigorosamente progetti di alta qualità e fornisce servizi di custodia patrimoniale sicuri e stabili. ',
  abdesc5:
  ...
  pt_card_rule6:
    '6. Il diritto di interpretazione finale della carta regalo gratuita appartiene a XCEX.',
  pt_card_day: 'cielo',
  ...
  just_for_learning: 'Questo progetto è solo per scopi di apprendimento e comunicazione, non per uso commerciale.'
};
