export default {
  ...
  indexTxt5: 'Xcex公式初心者エントリー補助チャンネル',
  indexLabel1: '暗号通貨取引',
  ...
  indexh8: '厳選されたプロジェクト',
  indexp1:
    'XCEX は初期のビットコイン参加者とオタクのグループによって設立され、チームの中心メンバーは Google、Microsoft、Alibaba、Tencent などの有名企業出身で、深い研究開発能力とインターネット製品の運用における豊富な経験を持っています。',
  indexp2:
    'Xcexは、基本的なブロックチェーンサービスプロバイダーとして位置付けられ、「悪を行わない」という基本原則を遵守し、誠実、公正、熱意を持って顧客にサービスを提供することを主張し、世界中のユーザーに高品質の暗号資産取引プラットフォームを提供することに尽力しています。ユーザーの基本的利益に利益をもたらすパートナー/プロジェクト。',
  indexp3:
  ...
  labTxt: 'XCEX Laboratory • イノベーション成果の共有',
  labTxt2:
  ...
  attentiontxt4:
    '※本アクティビティの最終解釈権はXcex公式（WWW.XCEX.NET）に帰属します。',
  transfer: '口座振替え',
  placeholder: '通貨の検索',
  bith1: '契約取引',
  bith2: 'アカウントの権利',
  ...
  cr1btn: '広告を掲載する',
  cr1btn2: '降伏を申請する',
  reTxt: 'Xcex Financial Management • ワンストップ投資ソリューション',
  ...
  prtit: 'ルールの詳細',
  prdesc:
    'Xcexの【プロモーションパートナー】は、ネットワーク全体で最高の手数料リベート率と最長のリベート期間（最大生涯リベート）を誇るプロモーション活動であり、相応の努力をしたプロモーターがプラッ トフォームの真の「パートナー」となり、配当金を享受することができます。 Xcex取引プラットフォームとともに成長していきます！',
  prli1:
    '1.Xcexは、デジタルアセットの概念を推進し、ユーザー規模を拡大するために、長期にわたって効果を発揮する【プロモーションパートナー】プログラムを開始しました。',
  prli2:
  ...
  prli8:
    '8. プロモーション手数料ランキングの上位10名または上位100名には、Xcexが公式に発行する追加報酬が随時提供されます。',
  prli9:
  ...
  prli11: '11. 本アクティビティの最終解釈権はXcexに帰属します。',
  prth1: 'レベル',
  prth2: '第一レベルの友達の数',
  ...
  abtit4: 'ビザンコミュニティ',
  abdesc:
    'XCEX は、テクノロジーを活用した世界有数のデジタル資産取引プラットフォームで、ケイマン諸島に登録されており、中核的な運営チームは香港にあります。 ',
  abdesc2:
    'Xcexプラットフォームは、専門的な金融レベルのトランザクション構造と自社開発の高同時実行メモリマッチングトランザクションエンジンを備え、完全コールドリチャージウォレットシステム+マルチシグ ネチャ+高保護DDOS攻撃システムなどのトランザクション構造を採用し、顧客資産の安全。',
  abdesc3:
    'Xcexでは、お客様がより投資機会を掴めるよう、カスタマーサービス部門内でのフラットマネジメントを採用し、極めて迅速なサービス対応体制を確立しており、アセットカスタマーサービスマネージャーが年中無休で7時間365日オンラインでお客様に資産運用などのサービスを提供しています。顧客が 5 分以内に応答できることを保証し、資産の入出金を完了します。',
  abdesc4:
    'Xcexは質の高い案件を厳選し、安全•安定した資産お預かりサービスをご提供いたします。 ',
  abdesc5:
  ...
  pt_card_rule6: '6. 無料ギフトカードの最終解釈権はXcexに帰属します。',
  pt_card_day: '空',
  ...
  just_for_learning: 'このプロジェクトは学習とコミュニケーションの目的のみであり、商業目的には使用しません。'
};
