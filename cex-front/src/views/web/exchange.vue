                          ...
                          <el-form :model="form" ref="form" class="u2-form" style="margin-bottom: 0px;">
                            ...
                            <el-form-item>
                              <div class="u2-form-item">
                                ...
                                <div class="u2-form-item__bd flex_bd">
                                  <el-input type="number" v-model.number="form.buy.limitAmount" :min="0" 
                                  @input="buyLimitAmount"> </el-input>
                                </div>
                                <div class="u2-form-item__ft">
                                  {{ currentCoin.coin }}
                                </div>
                          ...
                          <el-form-item>
                            <div class="u2-form-item">
                              ...
                              <div class="u2-form-item__bd flex_bd">
                                <el-input 
                                    type="number" :min="0"
                                    v-model.number="form.buy.limitAmount"
                                ></el-input>
                              </div>
                              <div class="u2-form-item__ft">
                                {{ currentCoin.coin }}
...
export default {
  ...
  methods: {
    ...
    buyLimitAmount(value) {
      ...
      this.form.buy.limitTurnover = this.toFloor(value * this.form.buy.limitPrice, this.baseCoinScale)
    },
    initDepth() {
      this.getPlateFull()
    },
    ...
    getSymbol() {
      symbolThumb().then(res => {
        ...
        // 设置默认信息
        this.currentCoin.symbol = "BTC/USDT"
      })
    },
    getPlateFull() {
      plateFull({
    ...
    successCallback(that, stompClient) {
      that.$refs.tv.getKline({
        a: process.env.VUE_APP_MARKET_API_URL + '/market',
        b: that.currentCoin,
        c: stompClient,
    ...
    startWebsock() {
      ...
      var that = this
      console.log("info:连接websocket")
      var socket = new SockJS(process.env.VUE_APP_MARKET_API_URL + '/market/market-ws')
